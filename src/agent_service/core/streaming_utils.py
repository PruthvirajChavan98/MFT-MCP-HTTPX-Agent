...
class StreamingUtils:
    ...
    def accumulate_usage(state: StreamingState, usage_metadata: Any) -> None:
        ...
        try:
            ...
            # Prompt/Input tokens
            prompt_tokens = (
                usage_dict.get("input_tokens", 0) or 
            ...
            completion_tokens = (
                usage_dict.get("output_tokens", 0) or 
            ...
            # Cached tokens
            cached_tokens = (
                usage_dict.get("cache_read_input_tokens", 0) or 
...
class SSEEventFormatter:
    ...
    @staticmethod
    def tool_end_event(tool_name: str, output: str, tool_call_id: Optional[str] = None) -> Dict[str, Any]:
        """Return dict - sse-starlette handles formatting."""
        return {
            "event": "tool_end",
            "data": {
    ...
    @staticmethod
    def cost_event(total_cost: float, usage: Dict[str, int], model: str, provider: str, cached: bool = False) -> Dict[str, Any]:
