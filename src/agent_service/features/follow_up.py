...
class FollowUpQuestionGenerator:
    ...
    async def generate_questions(
        ...
        return [collected_questions[i].strip() for i in sorted(collected_questions.keys()) if collected_questions[i].strip()]
    ...
    async def generate_questions_stream(
        ...
        if openrouter_key and collected_questions:
            final_qs = [collected_questions[i].strip() for i in sorted(collected_questions.keys()) if collected_questions[i].strip()]
            if final_qs:
