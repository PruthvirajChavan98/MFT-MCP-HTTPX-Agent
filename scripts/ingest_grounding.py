...
def ingest_grounding_data(openrouter_key: str):
    ...
    with driver.session() as session:
        ...
        session.run("CREATE CONSTRAINT grounding_uniq IF NOT EXISTS FOR (g:GroundingQuestion) REQUIRE g.text IS UNIQUE")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-openrouter", type=str, help="OpenRouter API Key", default=os.getenv("OPENROUTER_API_KEY"))
